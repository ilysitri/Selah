...
import type { ActiveSubscription, AndroidSubscriptionOfferInput, DeepLinkOptions, InitConnectionConfig, ExternalPurchaseCustomLinkNoticeResultIOS, ExternalPurchaseCustomLinkTokenResultIOS, ExternalPurchaseCustomLinkTokenTypeIOS, ExternalPurchaseLinkResultIOS, ExternalPurchaseNoticeResultIOS, DeveloperProvidedBillingDetailsAndroid, MutationFinishTransactionArgs, ProductCommon, PromotionalOfferJwsInputIOS, PurchaseCommon, PurchaseOptions, PurchaseUpdatedListenerOptions, VerifyPurchaseAppleOptions, VerifyPurchaseGoogleOptions, VerifyPurchaseHorizonOptions, VerifyPurchaseResultAndroid, RequestPurchaseIosProps, RequestPurchaseResult, RequestSubscriptionAndroidProps, UserChoiceBillingDetails, PaymentModeIOS, SubscriptionProductReplacementParamsAndroid, WinBackOfferInputIOS } from '../types';
...
export interface RnIap extends HybridObject<{
     ...
     */
    addPurchaseUpdatedListener(listener: (purchase: NitroPurchase) => void, options?: NitroPurchaseUpdatedListenerOptions): number;
    /**
     ...
     */
    addSubscriptionBillingIssueListener(listener: (purchase: NitroPurchase) => void): void;
    /**
     * Remove a subscription billing-issue listener.
     */
    removeSubscriptionBillingIssueListener(listener: (purchase: NitroPurchase) => void): void;
    /**
     ...
     */
    getExternalPurchaseCustomLinkTokenIOS(tokenType: ExternalPurchaseCustomLinkTokenTypeIOS): Promise<ExternalPurchaseCustomLinkTokenResultIOS>;
    /**
     ...
     */
    showExternalPurchaseCustomLinkNoticeIOS(noticeType: ExternalPurchaseCustomLinkNoticeTypeIOS): Promise<ExternalPurchaseCustomLinkNoticeResultIOS>;
}
export {};
